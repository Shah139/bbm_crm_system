...
const generateMockShowroomData = (): ShowroomActivity[] => {
  const showrooms = ['Showroom A', 'Showroom B', 'Showroom C', 'Showroom D', 'Showroom E', 'Showroom F'];
...
export default function ShowroomActivityPage() {
  const [showroomData, setShowroomData] = useState<ShowroomActivity[]>(generateMockShowroomData());
