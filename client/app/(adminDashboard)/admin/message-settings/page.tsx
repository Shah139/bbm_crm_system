      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <form onSubmit={handleSaveSettings} className="space-y-6">
            ...
            {/* API Key Field */}
            <div>
              <label htmlFor="smsApiKey" className="block text-sm font-medium text-gray-700 mb-2">
                API Key
              </label>
            ...
            {/* Sender ID Field */}
            <div>
              <label htmlFor="smsSenderId" className="block text-sm font-medium text-gray-700 mb-2">
                Sender ID
              </label>
              <input
                type="text"
                ...
                onChange={handleInputChange}
                placeholder="e.g., YourBrand or 1234"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 transition"
              />
              <p className="text-xs text-gray-500 mt-1">
            ...
            {/* Feedback URL Field */}
            <div>
              <label htmlFor="feedbackUrl" className="block text-sm font-medium text-gray-700 mb-2">
                Feedback URL
              </label>
              <input
                type="url"
                ...
                onChange={handleInputChange}
                placeholder="e.g., https://yourapp.com/user/feedback"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 transition"
              />
              <p className="text-xs text-gray-500 mt-1">
                Link used in SMS for collecting customer feedback
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 pt-6 border-t border-gray-200">
              <button
                ...
                disabled={isLoading}
                className="w-full md:w-auto flex justify-center items-center text-sm gap-2 px-4 py-2 md:px-6 md:py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-lg transition-colors font-medium"
              >
                <Send size={24} />
                Test SMS
              </button>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full md:w-auto inline-flex justify-center items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-600 text-white rounded-lg transition-colors font-medium"
              >
                <Save size={24} />
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="text-sm text-blue-800">
            To get your SMS gateway credentials, visit your SMS provider's dashboard and navigate to the API settings section. Make sure to copy your API key and endpoint URL correctly.
          </p>
        </div>
      </div>
            ...
            <form onSubmit={handleTestSMS} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex-1 px-4 py-2 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-600 text-white rounded-lg transition-colors font-medium inline-flex items-center justify-center gap-2"
                >
                  <Send size={16} />
